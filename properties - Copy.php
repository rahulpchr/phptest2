  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="md:col-span-2 space-y-6">
      ...
      <div class="flex bg-white shadow-md rounded-lg overflow-hidden">
        <img src="https://www.amerimacmanagement.com/wp-content/uploads/2021/11/Overhead-Map-of-Possible-Residential-Area.jpg" alt="Property Image" class="w-1/3 h-full object-cover">
        <div class="p-4 flex flex-col justify-between">
          <h3 class="text-xl font-semibold mb-2">PLOT FOR SALE IN TRANSPORT NAGAR</h3>
          <p class="text-sm text-gray-600 mb-2"><i class="fas fa-map-marker-alt"></i> Transport Nagar, Bilaspur, Chhattisgarh, India</p>
          <p class="text-lg font-bold text-orange-600">₹4.50K / sqft</p>
          <p class="text-sm text-gray-500">Type: Plot</p>
          <p class="text-sm text-gray-500">Area: Transport Nagar</p>
        </div>
      </div>

      <!-- Property Card 2 -->
      <div class="flex bg-white shadow-md rounded-lg overflow-hidden">
        <img src="https://housingcart.s3.ap-south-1.amazonaws.com/projectImage/4p8g3JdzF-WhatsApp%20Image%202024-06-27%20at%207.33.46%20AM%20(1).jpeg" alt="Property Image" class="w-1/3 h-full object-cover">
        <div class="p-4 flex flex-col justify-between">
          <h3 class="text-xl font-semibold mb-2">PLOT FOR SALE IN SHARDA MANDIR ROAD</h3>
          <p class="text-sm text-gray-600 mb-2"><i class="fas fa-map-marker-alt"></i> Parsada, Chhattisgarh, India</p>
          <p class="text-lg font-bold text-orange-600">₹2.00Cr / acres</p>
          <p class="text-sm text-gray-500">Type: Plot</p>
          <p class="text-sm text-gray-500">Area: Sharda Mandir</p>
        </div>
      </div>
      ...
      <div class="flex bg-white shadow-md rounded-lg overflow-hidden">
        <img src="https://housingcart.s3.ap-south-1.amazonaws.com/projectImage/4p8g3JdzF-WhatsApp%20Image%202024-06-27%20at%207.33.46%20AM%20(1).jpeg" alt="Property Image" class="w-1/3 h-full object-cover">
        <div class="p-4 flex flex-col justify-between">
          <h3 class="text-xl font-semibold mb-2">Land For Sale In Baitalpur</h3>
          <p class="text-sm text-gray-600 mb-2"><i class="fas fa-map-marker-alt"></i> Baitalpur, Chhattisgarh, India</p>
          <p class="text-lg font-bold text-orange-600">₹5.00L / acres</p>
          <p class="text-sm text-gray-500">Type: Plot</p>
          <p class="text-sm text-gray-500">Area: Baitalpur</p>
        </div>
      </div>
